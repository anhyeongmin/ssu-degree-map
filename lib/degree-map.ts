...
export const studentCases: StudentCase[] = [
  ...
  },
  {
    ...
    requirements: [
      ...
      req({ id:"b-duplicate-major", group:"졸업필수 요건", name:"복필·기계", kind:"credit", required:5, earned:5, unit:"학점", status:"충족", courses:"고체역학실험, 기계공작실습, 열공학실험, 전산기계제도", reason:"복수전공 관련 지정 5학점을 충족했습니다.", action:"추가 이수가 필요하지 않습니다.", source:"학부 복필-기계 5" }),
